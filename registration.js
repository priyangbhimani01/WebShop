function check(){
    ...
    var ipt_Cpassword = CPasswordField.value;
    ...
    if(ipt_password != ipt_Cpassword) {
        alert("Passwords do not match!")
        CPasswordField.classList.remove('success');
        CPasswordField.classList.add('error');
        return false;
    } else {
        CPasswordField.classList.remove('error');
        CPasswordField.classList.add('success');
    }
